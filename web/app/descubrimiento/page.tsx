      ...
      <section className="studio-index__hero">
        ...
        <StudioReveal delay={0.08}>
          <p className="studio-index__hero-lead">
            No es una call larga gratis. Es un cuestionario guiado (2–4 min) para que yo lea tu
            negocio a fondo y detecte dónde se te van el tiempo y los clientes. Llegas a la primera
            conversación con un diagnóstico ya hecho, no con una hoja en blanco. Si quieres
            profundizar: sesión estratégica 20 min · 25 CHF.
          </p>
        </StudioReveal>
      </section>
        ...
        <div className="mx-auto grid max-w-7xl gap-8 lg:grid-cols-[0.7fr_1.3fr]">
          <aside className="h-fit rounded-[18px] border border-[var(--editorial-gold)]/30 bg-[var(--editorial-ivory)]/[0.05] p-6">
            ...
            <div className="mt-6 space-y-5">
              {[
                ['01', 'Completas 5 pasos guiados (2–4 min)'],
                ['02', 'Reviso tu caso a mano y te mando el pre-análisis por email'],
                ['03', 'Si encajamos: sesión estratégica de 25 CHF con mini-ruta'],
                ['04', 'Proyecto con pack y precio cerrado, sin sorpresas'],
              ].map(([number, text]) => (
            ...
            <p className="mt-7 border-t border-[var(--editorial-ivory)]/12 pt-5 text-xs leading-6 text-[var(--editorial-lavender)]/80">
              Cuanto más concreto seas (URL, cómo llegan tus clientes, qué tareas haces a mano),
              más afinado sale el pre-análisis y más rápido detecto dónde recuperar horas y ventas.
              Si el envío automático falla, te dejo opción de email/WhatsApp para que nada se pierda.
            </p>
            <Link
