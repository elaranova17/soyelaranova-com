...
6. **Fotos permitidas** — solo `media/servicios/` + `slide-proceso-fondo.webp` (lote Evelyn 24 jul). Prohibido kit IA, selfies, `media/recursos/`, `media/cursos/`.
...
| Carpeta / archivo | Uso |
|---|---|
| `_assets/photos/slide-proceso-fondo.webp` | Slide immersive (foto Evelyn) |
| `media/servicios/` | 3 fotos de servicios (lote Evelyn) |
