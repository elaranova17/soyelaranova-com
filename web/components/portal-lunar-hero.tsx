...
import { OracleRitualPanel } from './oracle-ritual-panel'
...
export function PortalLunarHero({ revealDelay = 0 }: { revealDelay?: number }) {
  ...
  return (
    ...
    >
      ...
      {/* Z5 — CONTENIDO (nav global en layout → SiteNav) */}
      <div
        ref={contentRef}
        className="relative z-30 mx-auto grid min-h-screen max-w-6xl grid-cols-1 items-center gap-10 px-6 pb-32 pt-28 md:px-12 lg:grid-cols-[1fr_auto] lg:gap-14"
      ...
      >
        ...
        >
          Sacá tu carta del día, dejá tu correo y volvé mañana. Un ritual breve
          para mujeres latinas en reinvención.
        </motion.p>
